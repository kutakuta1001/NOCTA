...
window.HINA_BIRTH = [
  {
    month: 1,
    flower: { name: "水仙", hex: "#F2C14E", img: "https://upload.wikimedia.org/wikipedia/commons/7/79/Narcissus_poeticus_Spechtensee_01.JPG" },
  ...
  {
    month: 2,
    flower: { name: "梅", hex: "#D96BA0", img: "https://upload.wikimedia.org/wikipedia/commons/5/5a/Prunus_mume_G02.JPG" },
  ...
  {
    month: 3,
    flower: { name: "チューリップ", hex: "#E63A2E", img: "https://upload.wikimedia.org/wikipedia/commons/4/4c/Tulip_cv._34.JPG" },
  ...
  {
    month: 4,
    flower: { name: "桜", hex: "#F7C6D4", img: "https://upload.wikimedia.org/wikipedia/commons/0/0f/Cherry_blossoms_%28Prunus_x_yedoensis_%27Awanui%27%29_with_dew_drops_close-up.jpg" },
  ...
  {
    month: 5,
    flower: { name: "藤", hex: "#8172B8", img: "https://upload.wikimedia.org/wikipedia/commons/6/69/Japanese_wisteria%2C_Ashikaga_Flower_Park_2.jpg" },
  ...
  {
    month: 6,
    flower: { name: "紫陽花", hex: "#5F82BD", img: "https://upload.wikimedia.org/wikipedia/commons/1/14/Hydrangea_macrophylla_2021.2.jpg" },
  ...
  {
    month: 7,
    flower: { name: "蓮", hex: "#E8A0BF", img: "https://upload.wikimedia.org/wikipedia/commons/e/ed/Sacred_lotus_Nelumbo_nucifera.jpg" },
  ...
  {
    month: 8,
    flower: { name: "ひまわり", hex: "#F5C518", img: "https://upload.wikimedia.org/wikipedia/commons/e/eb/Sunflowers_helianthus_annuus.jpg" },
  ...
  {
    month: 9,
    flower: { name: "桔梗", hex: "#5B6FB0", img: "https://upload.wikimedia.org/wikipedia/commons/6/6a/Platycodon_grandiflorus_%28flower_s2%29.jpg" },
  ...
  {
    month: 10,
    flower: { name: "金木犀", hex: "#F08A24", img: "https://upload.wikimedia.org/wikipedia/commons/2/27/Osmanthus_fragrans_var._aurantiacus.JPG" },
  ...
  {
    month: 11,
    flower: { name: "菊", hex: "#D4A02C", img: "https://upload.wikimedia.org/wikipedia/commons/5/51/Chrysanthemum_%C3%97_morifolium_Dompierre_1.jpg" },
  ...
  {
    month: 12,
    flower: { name: "シクラメン", hex: "#C6407A", img: "https://upload.wikimedia.org/wikipedia/commons/3/31/Cyclamen_persicum_flower2.JPG" },
